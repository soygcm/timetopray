...
abstract class SPluginBase extends CWidget
{
    ...
    protected function renderTag($name, $params) {
        ...
        /*$assetUrl = Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('ext.yii-facebook-opengraph.plugins.assets'));
        $tagScriptFile   = $assetUrl.'/'.$name.'.js';
        echo $tagScriptFile;
        Yii::app()->clientScript->registerScriptFile($tagScriptFile, CClientScript::POS_END);
        */
    }
